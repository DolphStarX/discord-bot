...
module.exports = {
  ...
  async execute(message, args, cmd, client, discord, profileData) {
    if (message.member.id != "217682431409389568") return message.channel.send(`Sorry only **Dolph** can run this command 😔`);
    ...
    try {
      ...
      return message.channel.send(`This member has been given ${amount} coins!`);
    } catch (err) {
      console.log(err);
    }
  },
